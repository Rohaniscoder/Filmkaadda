...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002089167493').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002130593333'))
...
URL = "https://film-ka-adda.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://film-ka-adda.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://film-ka-adda.onrender.com/".format(FQDN)
else:
    URL = "https://film-ka-adda.onrender.com/".format(FQDN)
